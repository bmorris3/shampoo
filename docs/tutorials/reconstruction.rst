...
Let's set up a similar reconstruction to the one in the example above, where
we'll reconstruct the USAF target five times::
...
The minimum in the sum of the intensities is found at the same propagation
distance as we found in the early example.
